...
import com.frogobox.composeui.loadingindicator.indicators.BallPulseIndicator;

public class FrogoLoadingIndicatorView extends View {

    private static final String TAG = FrogoLoadingIndicatorView.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.FrogoLoadingIndicatorView, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(R.styleable.FrogoLoadingIndicatorView_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.FrogoLoadingIndicatorView_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.FrogoLoadingIndicatorView_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.FrogoLoadingIndicatorView_maxHeight, mMaxHeight);
        String indicatorName = a.getString(R.styleable.FrogoLoadingIndicatorView_indicatorName);
        mIndicatorColor = a.getColor(R.styleable.FrogoLoadingIndicatorView_indicatorColor, Color.WHITE);
